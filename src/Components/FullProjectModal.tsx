...
const FullProjectModal = (props: any) => {
    ...
    const techno = useMatches({ xs: "md", sm: "md", md: "lg", lg: "xl" });
                ...
                <Modal.Body className="!bg-bgColor xs-mx:!p-2 !pt-2 !border-primaryColor !border-2 !border-t-0 !rounded-bl-3xl !rounded-br-3xl">
                    ...
                    <Group justify="space-between" mt="md" mb={3}>
                        <a href={props.github} target="_blank" className="!w-[48%] sm-mx:!w-[46%]">
                            <Button variant="outline" size={btn} color="#64FFDA" className="!w-full" radius="md">
                                View Code
                            </Button>
                        </a>
                        <a href={props.link} target="_blank" className="!w-[48%]">
                            <Button size={btn} color="#64FFDA" className="!text-bgColor !w-full" radius="md">
                                View Live App
                            </Button>
                        </a>
                    </Group>
